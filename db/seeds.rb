...
Post.create(
    ...
    link: "https://www.amazon.co.jp/dp/B07JHQ9B5T/",
    rate: 8,
    user_id: 1
)
...
Post.create(
    ...
    link: "https://www.amazon.co.jp/dp/4774142042/",
    rate: 7,
    user_id: 1
)
...
Post.create(
    ...
    link: "https://www.amazon.co.jp/dp/B077Q8BXHC/",
    rate: 8,
    user_id: 1
)
...
Post.create(
    ...
    link: "https://www.amazon.co.jp/dp/B00E5TJ120/",
    rate: 9,
    user_id: 1
)
...
デザインはデザイナーだけに必要な要素ではありません。いまやエクセルやワード、パワーポイントを使って資料を作る際にも重要となります。読みやすいデザイン、伝わるプレゼン資料、わかりやすいレイアウトを作りたい方におすすめの一冊です。",
    link: "https://www.amazon.co.jp/dp/B01LW1BC2L/",
    rate: 6,
    user_id: 1
)
Post.create(
    ...
    link: "https://www.amazon.co.jp/dp/B07PNN3TYF/",
    rate: 4,
    user_id: 1
)
...
Post.create(
    ...
    link: "https://www.amazon.co.jp/dp/B01HD5VWWO/",
    rate: 9,
    user_id: 1
)
...
Post.create(
    ...
    link: "https://www.amazon.co.jp/dp/4844365177/",
    rate: 7,
    user_id: 1
)
...
Post.create(
    ...
    link: "https://www.amazon.co.jp/dp/4873115655/",
    rate: 10,
    user_id: 1
)
...
Post.create(
    ...
    link: "https://www.amazon.co.jp/dp/B00IRRTFNG/",
    rate: 8,
    user_id: 1
)
